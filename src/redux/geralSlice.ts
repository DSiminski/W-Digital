...
export const { editaDespesas, editaPeriodoFinal, editaPeriodoInicial, editaValor, editaMetodoDePagamento, editaMoeda, editaTag, editaDescricao, editaValorTotal, editaValorDolar, editaAtualizaValorDolar, editaDataDaDespesa } = geralSlice.actions
